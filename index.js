...
export default class Pdf extends Component {
  ...
  _renderActivityIndicator = () => {
    const { activityIndicator, activityIndicatorProps } = this.props;

    if (activityIndicator) return activityIndicator;
  ...
  render() {
    ...
    return (
      <View style={[this.props.style, { overflow: 'hidden' }]}>
        ...
        {isDownloaded && IS_IOS && ((this.props.usePDFKit && this.state.isSupportPDFKit === 1)
          ? (
            <PdfCustom
              ref={component => (this._root = component)}
              {...this.props}
